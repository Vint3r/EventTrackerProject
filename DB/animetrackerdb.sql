...
START TRANSACTION;
USE `animetrackerdb`;
INSERT INTO `day_aired` (`id`, `day`) VALUES (id, 'day');
...
START TRANSACTION;
USE `animetrackerdb`;
INSERT INTO `season` (`id`, `season`) VALUES (id, 'season');
...
START TRANSACTION;
USE `animetrackerdb`;
INSERT INTO `anime` (`id`, `title`, `description`, `simulcast`, `interested_in`, `day_aired_id`, `season_id`, `release_year`, `image_url`) VALUES (id, 'title', 'description', simulcast, interested_in, day_aired_id, season_id, 'release_year', 'image_url');
...
START TRANSACTION;
USE `animetrackerdb`;
INSERT INTO `category` (`id`, `category`) VALUES (id, 'category');
...
INSERT INTO `category` (`id`, `category`) VALUES (6, 'Harem');
INSERT INTO `category` (`id`, `category`) VALUES (7, 'Romance');
INSERT INTO `category` (`id`, `category`) VALUES (8, 'Action');
INSERT INTO `category` (`id`, `category`) VALUES (9, 'Sci-Fi');
INSERT INTO `category` (`id`, `category`) VALUES (10, 'Super Power');
INSERT INTO `category` (`id`, `category`) VALUES (11, 'Psychological');
INSERT INTO `category` (`id`, `category`) VALUES (12, 'Magic');
INSERT INTO `category` (`id`, `category`) VALUES (13, 'Thriller');
INSERT INTO `category` (`id`, `category`) VALUES (14, 'Isekai');
INSERT INTO `category` (`id`, `category`) VALUES (15, 'Parody');
INSERT INTO `category` (`id`, `category`) VALUES (16, 'Fantasy');
INSERT INTO `category` (`id`, `category`) VALUES (17, 'Mystery');
INSERT INTO `category` (`id`, `category`) VALUES (18, 'Supernatural');
INSERT INTO `category` (`id`, `category`) VALUES (19, 'Seinen');
INSERT INTO `category` (`id`, `category`) VALUES (20, 'Demons');
INSERT INTO `category` (`id`, `category`) VALUES (21, 'Ecchi');
INSERT INTO `category` (`id`, `category`) VALUES (22, 'Adventure');
INSERT INTO `category` (`id`, `category`) VALUES (23, 'Slice of Life');
INSERT INTO `category` (`id`, `category`) VALUES (24, 'Horror');
INSERT INTO `category` (`id`, `category`) VALUES (25, 'Game');
INSERT INTO `category` (`id`, `category`) VALUES (26, 'Martial Arts');
INSERT INTO `category` (`id`, `category`) VALUES (27, 'Music');
INSERT INTO `category` (`id`, `category`) VALUES (28, 'Josei');
INSERT INTO `category` (`id`, `category`) VALUES (29, 'Historical');
INSERT INTO `category` (`id`, `category`) VALUES (30, 'Kids');
